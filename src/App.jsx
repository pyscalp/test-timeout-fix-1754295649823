      ...
      <div id="main-content" className="transition-all duration-500">
          ...
          <div className="container mx-auto px-4 py-4">
            <div className="flex justify-between items-center">
              <div className="flex items-center space-x-2">
                <h1 className="text-2xl font-bold text-gray-800">Test Timeout Fix</h1>
        ...
        <section id="home" className="relative bg-gradient-to-r from-blue-600 via-purple-600 to-blue-800 text-white py-20">
          ...
          <div className="relative container mx-auto px-4 text-center">
            <h1 className="text-5xl md:text-7xl font-bold mb-6 animate-pulse">Test Timeout Fix</h1>
            <p className="text-xl md:text-2xl mb-8 max-w-3xl mx-auto">
              Warung Makan Terpercaya dengan Layanan Berkualitas Tinggi
            </p>
              ...
              {[1, 2, 3, 4, 5, 6].map((item) => (
                <div key={item} className="bg-white rounded-lg shadow-lg p-6 hover:shadow-xl transition duration-300 transform hover:-translate-y-2">
                  ...
                  <p className="text-gray-600 mb-4">
                    Deskripsi layanan berkualitas tinggi dengan standar profesional terbaik untuk warung makan.
                  </p>
          ...
          <div className="container mx-auto px-4">
            ...
            <div className="max-w-2xl mx-auto text-center">
              <p className="text-xl mb-8">
                Siap melayani kebutuhan warung makan Anda dengan profesional dan terpercaya.
              </p>
              <div className="space-y-4">
                ...
                <div className="flex items-center justify-center space-x-2">
                  <span className="text-2xl">📧</span>
                  <span className="text-lg">info@testtimeoutfix.com</span>
                </div>
                <div className="flex items-center justify-center space-x-2">
                  <span className="text-2xl">📍</span>
          ...
          <div className="container mx-auto px-4">
            <div className="flex flex-col md:flex-row justify-between items-center">
              <div className="mb-4 md:mb-0">
                <p>&copy; 2024 Test Timeout Fix. Semua hak dilindungi.</p>
              </div>
              <div className="flex items-center space-x-2">
